...
public class CorsConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource(){
        ...
        config.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:5173", "http://localhost:8000", "http://localhost:8001",
                "http://127.0.0.1:8001", "http://127.0.0.1:3000", "http://127.0.0.1:5173", "http://127.0.0.1:8000", baseUrl)); // 허용할 출처 설정
